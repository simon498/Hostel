...
$query="insert into  registration(roomno,feespm,stayfrom,duration,name,gender,contactno,emailid,egycontactno) values(?,?,?,?,?,?,?,?,?)";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('iiiissisi',$roomno,$feespm,$stayfrom,$duration,$name,$gender,$contactno,$emailid,$egycontactno);
$stmt->execute();
